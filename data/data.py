...
cursor.execute("CREATE TABLE IF NOT EXISTS orders( orderId BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,usermail VARCHAR(255),attractionId BIGINT NOT NULL,date VARCHAR(255), time VARCHAR(255), price VARCHAR(255),status SMALLINT(1) NOT NULL)")
